...
@Schema(description = "Detailed view of the AgencyBoard, including associated project and briefing information.")
public record BAgencyBoardDetailedView(
        ...
        @Schema(description = "The view of the associated project.")
        ProjectView project,
