...
public class ApiExceptionHandler{
	...
	public ResponseEntity<ErrorMessage> handleHttpMessageNotReadableException(HttpMessageNotReadableException ex, HttpServletRequest request) {
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .contentType(MediaType.APPLICATION_JSON)
                .body(new ErrorMessage(request, HttpStatus.BAD_REQUEST, "O valor fornecido é inválido. Por favor, verifique os valores e tente novamente"));
	}
    ...
    public ResponseEntity<ErrorMessage> handleException(Exception ex, HttpServletRequest request) {
        ...
        return ResponseEntity
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .body(new ErrorMessage(request, HttpStatus.INTERNAL_SERVER_ERROR, "Internal server error"));
    }
   
    @ExceptionHandler(EntityNotFoundException.class)
    private ResponseEntity<ErrorMessage> entityNotFoundException(EntityNotFoundException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorMessage> uniqueViolationException(EmailUniqueViolationException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorMessage> methodArgumentNotValidException(HttpServletRequest request, MethodArgumentNotValidException ex, BindingResult result) {
        log.error("Api Error - " + ex);
        return ResponseEntity
